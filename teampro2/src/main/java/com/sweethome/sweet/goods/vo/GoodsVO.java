...
public class GoodsVO {
	...
	public String getGoods_bp_id() {
		return goods_bp_id;
	}

	public void setGoods_bp_id(String goods_bp_id) {
		this.goods_bp_id = goods_bp_id;
	}

	public int getDaposit() {
		return daposit;
	}

	public void setDaposit(int daposit) {
		this.daposit = daposit;
	}
